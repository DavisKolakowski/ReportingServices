...
import { useDownloadReportButton, useRefreshReportButton, useFetchReportDetails } from '../hooks';
...
const ReportView: React.FC = () => {
  ...
  return (
    <Box marginLeft={1}>
      ...
      {(refreshSnackbar || downloadSnackbar) && (
        <Snackbar
          open
        ...
        >
          <Alert onClose={handleSnackbarClose} severity={refreshSnackbar?.severity || downloadSnackbar?.severity}>
            {refreshSnackbar?.message || downloadSnackbar?.message}
          </Alert>
        </Snackbar>
      )}
      <ScrollToTopButton />
